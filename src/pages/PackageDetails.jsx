...
export default function PackageDetails() {
  ...
  return <>
    ...
    <div className="mobile-booking-bar"><span><small>Estimated total</small><strong>{formatCurrency(total)}</strong></span><button className="button accent" onClick={() => navigate(`/booking/${item.id}`, { state: travelers })}>Book now</button></div>
